...
public class CalculatorLocator extends org.apache.axis.client.Service implements Calculator {
    ...
    public CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CalculatorSoapStub _stub = new CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                CalculatorSoapStub _stub = new CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
