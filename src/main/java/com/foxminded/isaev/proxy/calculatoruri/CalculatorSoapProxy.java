...
public class CalculatorSoapProxy implements CalculatorSoap {
    private String _endpoint = null;
    private CalculatorSoap calculatorSoap = null;
    ...
    private void _initCalculatorSoapProxy() {
        try {
            calculatorSoap = (new CalculatorLocator()).getCalculatorSoap();
