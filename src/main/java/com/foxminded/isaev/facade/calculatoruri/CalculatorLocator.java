...
public class CalculatorLocator extends org.apache.axis.client.Service implements com.foxminded.isaev.facade.calculatoruri.Calculator {
    ...
    public com.foxminded.isaev.facade.calculatoruri.CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.foxminded.isaev.facade.calculatoruri.CalculatorSoapStub _stub = new com.foxminded.isaev.facade.calculatoruri.CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.foxminded.isaev.facade.calculatoruri.CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.foxminded.isaev.facade.calculatoruri.CalculatorSoapStub _stub = new com.foxminded.isaev.facade.calculatoruri.CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
